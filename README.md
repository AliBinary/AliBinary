    ...
    <body>
        ...
        <ul>
            ...
            <li>
                ...
                front-end Dev, I'll be happy to help
            </li>
            <li>
        ...
        <details>
            <summary>
                📫 (click to expand) <strong>How To Reach Me</strong>
            </summary>
            <br />
            <div align="center">
                ...
                /></a>
                <a href="https://www.coursera.org/learner/alibinary" target="_blank"
                    ><img
                         alt="Cursera Badge"
        ...
        <details>
            <summary>
                🚀 (click to expand) <strong>Languages And Tools</strong>
            </summary>
            <br />
            <div align="center">
                <ul>
        ...
        <details>
            <summary>
                🏆 (click to expand) <strong>GitHub Trophies</strong>
            </summary>
            <br />
            <div align="center">
                <a
